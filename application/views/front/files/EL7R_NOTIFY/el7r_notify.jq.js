...
(function($) {
	$.fn.el7r_notify = function(options) {
		...
		//if(options['icon']) { var icon = options['icon']; } else { var icon = '../application/views/front/files/EL7R_NOTIFY/icons/pixel.gif'; }
		if(options['icon']) { var icon = options['icon']; } else { var icon = window.location.protocol+"//"+window.location.host+'/optimus/application/views/front/files/EL7R_NOTIFY/icons/pixel.gif'; }
